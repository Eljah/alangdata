...
- `tat.training_text` — татар телендә тематик һәм заманча лексикадан
  торган корпус. 2024 елдагы инфраструктура, инновация, мәдәни
  инициативалар һәм белем бирү сценарийларын колачлаган 1000+ җөмлә
  кертелде, шуңа күрә тренировкалау өчен материал күләме берничә тапкыр
  артты.
